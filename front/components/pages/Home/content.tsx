        ...
        {data?.map((beer: any) => {
          return (
            <Link href={`/beer/${beer.id}`} key={beer.id}>
              <li className="w-[100%] max-w-[270px] min-h-[320px] shadow-lg rounded-[10px] relative cursor-pointer transition-all hover:scale-105">
                <div className="bg-amber-200 w-[100%] h-[60%] flex items-center justify-center rounded-t-lg p-3">
                  <img
                    src={beer.image_url}
                    alt="Cerveja"
                    width={500}
